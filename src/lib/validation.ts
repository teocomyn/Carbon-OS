...
export const assessmentAnswersSchema = z.object({
  ...
  trainService: z.enum(["tgv", "mixed", "regional"]).default("mixed"),
  motorcycleKm: z.number().min(0).max(50_000).default(5_000),
  transitKm: z.number().min(0).max(50_000).default(4_000),
  bikeKm: z.number().min(0).max(30_000).default(2_500),
